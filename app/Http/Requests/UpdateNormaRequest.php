...
class UpdateNormaRequest extends FormRequest
{
    ...
    public function withValidator(Validator $validator)
    {
        $validator->after(function ($validator) {
            ...
            if ($this->has('vigencia_indeterminada') || $this->has('data_limite_vigencia')) {
                ...
                if ($this->has('vigencia_indeterminada') && $vigenciaIndeterminada === false && empty($dataLimiteVigencia)) {
                    $validator->errors()->add(
                ...
                if ($this->has('vigencia_indeterminada') && $vigenciaIndeterminada === true && !empty($dataLimiteVigencia)) {
                    $validator->errors()->add(
                        'data_limite_vigencia', 
