            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h2 class="display-6 mb-2">
                        <i class="fas fa-university mr-3"></i>Órgãos
                    </h2>
                </div>
                <div class="col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-md-end">
                            ...
                            <li class="breadcrumb-item active">Órgãos</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <a href="{{ route('orgaos.orgao_create') }}" class="btn btn-secondary">
                    ...
                    @if($orgao->count() > 0)
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="text-muted small">
                                ...
                                Exibindo {{ $orgao->firstItem() }} a {{ $orgao->lastItem() }} 
                                de {{ $orgao->total() }} órgãos
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach($orgao as $orgao_obj)
                                        <tr>
                                            <td>{{ $orgao_obj->id }}</td>
                                            <td>
                                                <strong>{{ $orgao_obj->orgao }}</strong>
                                            </td>
                                            <td class="text-center">
                                                <div class="action-buttons">
                                                    <a href="{{ route('orgaos.orgao_edit', $orgao_obj->id) }}" 
                                                    ...
                                                    <button type="button" 
                                                            ...
                                                            title="Excluir"
                                                            onclick="confirmarExclusao({{ $orgao_obj->id }}, '{{ $orgao_obj->orgao }}')">
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            {{ $orgao->appends(request()->query())->links('pagination::bootstrap-4') }}
                        </div>
                    @else
                        <div class="text-center py-5">
                            <i class="fas fa-university fa-3x text-muted mb-3"></i>
                            <h5 class="text-muted">Nenhum órgão cadastrado</h5>
                            <p class="text-muted">Clique no botão "Novo Órgão" para começar.</p>
                            <a href="{{ route('orgaos.orgao_create') }}" class="btn btn-primary">
                                <i class="fas fa-plus me-1"></i>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Tem certeza que deseja excluir o órgão:</p>
                <p><strong id="nomeOrgao"></strong></p>
                <div class="alert alert-warning">
                    <i class="fas fa-info-circle me-1"></i>
                    <strong>Atenção:</strong> Não será possível excluir se houver normas vinculadas a este órgão.
                </div>
...
function confirmarExclusao(id, nome) {
    ...
    // Preencher dados
    document.getElementById('nomeOrgao').textContent = nome;
    document.getElementById('btnConfirmarExclusao').href = '{{ url("orgaos/excluir") }}/' + id;
