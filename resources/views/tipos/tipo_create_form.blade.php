<div class="row">
    <div class="col-md-12">
        <label class="section-form-label">Nome do Tipo</label>
        <input type="text" class="section-form-input {{ $errors->has('nome_tipo') ? 'border-error' : '' }}"
            name="nome_tipo" id="nome_tipo">
    </div>
</div>
...
<div class="row">
    <div class="col-md-4">
        <div class="btn-group">
            ...
            &nbsp;&nbsp;<a class="btn btn-secondary" href="{{route('normas.tipo_list')}}"><i class="fas fa-arrow-left"></i> Voltar para a lista</a>
        </div>
    </div>
</div>
