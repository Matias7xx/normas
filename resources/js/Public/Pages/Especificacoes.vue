<template>
  <PublicLayout :stats="pageStats">
    ...
    <section class="max-w-7xl mx-auto px-4 py-8 min-h-[60vh]">
      ...
      <!-- Lista de especificações -->
      <div
        v-else-if="especificacoes && especificacoes.length > 0"
        class="space-y-4"
      >
        <div
            ...
            >
              <div class="flex space-x-3">
                ...
                <button
                  v-if="especificacao?.arquivo"
                  @click="
                    baixarEspecificacao(especificacao?.id, especificacao?.nome)
                  "
                ...
                >
                  <i
                    ...
                    :class="{
                      'animate-spin': baixandoId === especificacao?.id,
                    }"
                  ></i>
                  {{
